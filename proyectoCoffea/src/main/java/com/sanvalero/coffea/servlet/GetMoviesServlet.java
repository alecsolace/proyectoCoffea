/*
 * package main.java.com.sanvalero.coffea.servlet;
 * 
 * import com.sanvalero.coffea.dao.MovieDAO;
 * import com.sanvalero.coffea.domain.Movie;
 ...
 * out.println("<li>" + movie.getTitle() + " <a href='remove-movie?id=" +
 * movie.getId() + "'>Eliminar</a></li>");
 * }
 * // FIXME pelicula de ejemplo (eliminar cuando se desarrolle el listado)
 * out.
 * println("<li>Pelicula de ejemplo</li> <a href='remove-movie?id=23'>Eliminar</a></li>"
 * );
 * out.println("</ul>");
 * 
